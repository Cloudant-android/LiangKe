...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        micImages = new Drawable[] { getResources().getDrawable(R.drawable.rc_ic_volume_0),
                getResources().getDrawable(R.drawable.rc_ic_volume_1),
                getResources().getDrawable(R.drawable.rc_ic_volume_2),
                getResources().getDrawable(R.drawable.rc_ic_volume_3),
                getResources().getDrawable(R.drawable.rc_ic_volume_4),
                getResources().getDrawable(R.drawable.rc_ic_volume_5),
                getResources().getDrawable(R.drawable.rc_ic_volume_6),
                getResources().getDrawable(R.drawable.rc_ic_volume_7),
                getResources().getDrawable(R.drawable.rc_ic_volume_8),
                 };
