...
public class ConversationAdapter extends BaseAdapter {
    ...
    public ConversationAdapter(Context context, List<EMConversation> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.em_row_chat_history, parent, false);
        }
