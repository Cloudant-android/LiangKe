...
import com.mchat.api.BuildConfig;
import com.mchat.api.R;
import com.mchat.api.hx.activity.RecorderVideoActivity;
import com.mchat.api.hx.utils.ImageCache;
import com.mchat.api.hx.utils.ImageResizer;
import com.mchat.api.hx.utils.Utils;
import com.mchat.api.hx.utils.VideoEntity;
import com.mchat.api.hx.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.mipmap.em_default_avatar);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.mipmap.em_default_avatar);
